...
async function parsePdfAndAddToDB() {
    const pdfPath = path_1.default.join(__dirname, "../document/mcqs_tex.pdf");
    ...
    for (const mcq of mcqs) {
        try {
            await axios_1.default.post("http://localhost:8000/api/mcq", {
                year: mcq.year,
...
//# sourceMappingURL=add_mcqs_from_pdfs.js.map